...
const HeroImageDecorations = () => {
  return (
    <div className="absolute inset-0 size-full border-x-2 border-t-2 border-white rounded-2xl">
      ...
      <div className="absolute -top-10 -left-10 size-20 bg-white rounded-full blur-2xl" />
      ...
      <div className="absolute -top-10 -right-10 size-20 bg-white rounded-full blur-2xl" />

      {/* <div className="absolute -translate-x-1/2 translate-y-1/2 bottom-0 left-0 size-60 bg-cyan-500 rounded-full blur-3xl" />
      <div className="absolute translate-x-1/2 translate-y-1/2 bottom-0 right-0 size-60 bg-blue-500 rounded-full blur-3xl" /> */}
    </div>
  );
};
